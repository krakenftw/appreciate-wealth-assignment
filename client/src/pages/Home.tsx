...
function Home() {
  return (
    <div className='w-screen h-screen bg-gradient-to-r from-purple-500 to-blue-400 flex flex-col'>
      <Navbar />
      <div className='flex-grow flex gap-3 flex-col items-center justify-center'>
